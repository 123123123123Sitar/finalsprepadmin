...
export function AdminSidebar({
  ...
  return (
    <aside className="w-full shrink-0 border-b border-line bg-ink text-slate-100 lg:min-h-screen lg:w-72 lg:border-b-0 lg:border-r">
      <div className="sticky top-0 flex flex-col gap-8 px-6 py-7 lg:h-screen">
        <div>
          <p className="text-xs font-medium uppercase tracking-[0.28em] text-orange-200">FinalsPrep</p>
          <h1 className="mt-3 font-display text-3xl text-white">Admin Console</h1>
